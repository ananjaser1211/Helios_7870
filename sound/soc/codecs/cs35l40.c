...
struct cs35l40_private {
	...
	bool halo_booted;
	bool amp_mute;
	unsigned int amp_mute_rx2_restore;
	/* GPIO for /RST */
...
static int cs35l40_halo_booted_get(struct snd_kcontrol *kcontrol,
...
static int cs35l40_halo_booted_put(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_soc_kcontrol_codec(kcontrol);
	struct cs35l40_private *cs35l40 = snd_soc_codec_get_drvdata(codec);
...
static int cs35l40_amp_mute_get(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_soc_kcontrol_codec(kcontrol);
	struct cs35l40_private *cs35l40 = snd_soc_codec_get_drvdata(codec);

	ucontrol->value.integer.value[0] = cs35l40->amp_mute;

	return 0;
}

static int cs35l40_amp_mute_put(struct snd_kcontrol *kcontrol,
			   struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_soc_kcontrol_codec(kcontrol);
	struct cs35l40_private *cs35l40 = snd_soc_codec_get_drvdata(codec);
	...
	cs35l40->amp_mute = ucontrol->value.integer.value[0];

	if (ucontrol->value.integer.value[0] == 0) {
		/* Mute and set DSP inputs to zero-fill */
		regmap_update_bits(cs35l40->regmap, CS35L40_AMP_DIG_VOL_CTRL,
					CS35L40_AMP_VOL_PCM_MASK <<
					CS35L40_AMP_VOL_PCM_SHIFT,
					CS35L40_AMP_VOL_PCM_MUTE <<
					CS35L40_AMP_VOL_PCM_SHIFT);
		regmap_read(cs35l40->regmap, CS35L40_DSP1_RX2_SRC,
					&temp);
		if (temp == CS35L40_INPUT_SRC_ASPRX1 ||
				temp == CS35L40_INPUT_SRC_ASPRX2)
			cs35l40->amp_mute_rx2_restore = temp;
		regmap_write(cs35l40->regmap, CS35L40_DSP1_RX1_SRC,
						0x00);
		regmap_write(cs35l40->regmap, CS35L40_DSP1_RX2_SRC,
						0x00);

	} else if (ucontrol->value.integer.value[0] == 1) {
		/* Un-mute and set DSP inputs to ASP */
		regmap_update_bits(cs35l40->regmap, CS35L40_AMP_DIG_VOL_CTRL,
					CS35L40_AMP_VOL_PCM_MASK <<
					CS35L40_AMP_VOL_PCM_SHIFT,
					CS35L40_AMP_VOL_PCM_DEFAULT <<
					CS35L40_AMP_VOL_PCM_SHIFT);
		regmap_write(cs35l40->regmap, CS35L40_DSP1_RX1_SRC,
						CS35L40_INPUT_SRC_ASPRX1);
		regmap_write(cs35l40->regmap, CS35L40_DSP1_RX2_SRC,
						cs35l40->amp_mute_rx2_restore);
...
static SOC_VALUE_ENUM_SINGLE_DECL(cs35l40_dsprx2_enum,
				CS35L40_DSP1_RX2_SRC,
				0, CS35L40_ASP_SOURCE_MASK,
				cs35l40_tx_input_texts,
				cs35l40_tx_input_values);

static const struct snd_kcontrol_new dsp_rx2_mux =
	SOC_DAPM_ENUM("DSPRX2 SRC", cs35l40_dsprx2_enum);
...
static const struct snd_kcontrol_new cs35l40_aud_controls[] = {
	...
	SOC_SINGLE_EXT("AMP Mute", SND_SOC_NOPM, 0, 1, 0,
			cs35l40_amp_mute_get, cs35l40_amp_mute_put),
...
static int cs35l40_otp_unpack(void *data)
{
	 ...
	 * registers correctly
	 */
	regcache_cache_bypass(cs35l40->regmap, true);

	regmap_write(cs35l40->regmap, CS35L40_TEST_KEY_CTL, 0x00005555);
	regmap_write(cs35l40->regmap, CS35L40_TEST_KEY_CTL, 0x0000AAAA);
	...
	regmap_write(cs35l40->regmap, CS35L40_TEST_KEY_CTL, 0x0000CCCC);
	regmap_write(cs35l40->regmap, CS35L40_TEST_KEY_CTL, 0x00003333);

	regcache_cache_bypass(cs35l40->regmap, false);
...
static irqreturn_t cs35l40_irq(int irq, void *data)
{
	...
	if (status[0] & CS35L40_AMP_SHORT_ERR) {
		...
		regmap_write(cs35l40->regmap, CS35L40_IRQ1_STATUS1,
					CS35L40_AMP_SHORT_ERR);
		regmap_write(cs35l40->regmap, CS35L40_PROTECT_REL_ERR_IGN, 0);
	...
	if (status[0] & CS35L40_BST_OVP_ERR) {
		...
		regmap_update_bits(cs35l40->regmap, CS35L40_PWR_CTRL2,
					CS35L40_BST_EN_MASK, 0);
		regmap_write(cs35l40->regmap, CS35L40_IRQ1_STATUS1,
					CS35L40_BST_OVP_ERR);
		regmap_write(cs35l40->regmap, CS35L40_PROTECT_REL_ERR_IGN, 0);
		regmap_update_bits(cs35l40->regmap, CS35L40_PROTECT_REL_ERR_IGN,
		...
		regmap_update_bits(cs35l40->regmap, CS35L40_PWR_CTRL2,
					CS35L40_BST_EN_MASK,
					CS35L40_BST_EN_DEFAULT <<
					CS35L40_BST_EN_SHIFT);
	}
...
static void cs35l40_pup_errata(struct cs35l40_private *cs35l40)
{
	regmap_write(cs35l40->regmap, 0x00000040, 0x00005555);
	regmap_write(cs35l40->regmap, 0x00000040, 0x0000AAAA);
	regmap_write(cs35l40->regmap, 0x00002084, 0x002F1AA0);
	regmap_write(cs35l40->regmap, 0x00000040, 0x0000CCCC);
	regmap_write(cs35l40->regmap, 0x00000040, 0x00003333);
}

static void cs35l40_pdn_errata(struct cs35l40_private *cs35l40)
{
	regmap_write(cs35l40->regmap, 0x00000040, 0x00005555);
	regmap_write(cs35l40->regmap, 0x00000040, 0x0000AAAA);
	regmap_write(cs35l40->regmap, 0x00002084, 0x002F1AA3);
	regmap_write(cs35l40->regmap, 0x00000040, 0x0000CCCC);
	regmap_write(cs35l40->regmap, 0x00000040, 0x00003333);
}
...
static int cs35l40_pcm_mute(struct snd_soc_dai *dai, int mute)
{
	struct snd_soc_codec *codec = dai->codec;
	struct cs35l40_private *cs35l40 = snd_soc_codec_get_drvdata(codec);
	unsigned int temp;

	/* If amp_mute is set to mute, don't unmute or mute */
	if (cs35l40->amp_mute == 0)
		return 0;
	...
	dev_info(cs35l40->dev, "%s mute(%d) amp_mute(%d)\n", __func__,
						mute, cs35l40->amp_mute);
				 ...
				 struct snd_soc_dai *dai)
{
	...
	if (i < ARRAY_SIZE(cs35l40_fs_rates))
...
static int cs35l40_codec_probe(struct snd_soc_codec *codec)
{
	...
	if (cs35l40->pdata.dsp_ng_enable) {
		regmap_update_bits(cs35l40->regmap,
				CS35L40_MIXER_NGATE_CH1_CFG,
				CS35L40_DSP_NG_ENABLE_MASK,
				CS35L40_DSP_NG_ENABLE_MASK);
		regmap_update_bits(cs35l40->regmap,
		...
		if (cs35l40->pdata.dsp_ng_pcm_thld) {
			regmap_update_bits(cs35l40->regmap,
				CS35L40_MIXER_NGATE_CH1_CFG,
				CS35L40_DSP_NG_THLD_MASK,
				cs35l40->pdata.dsp_ng_pcm_thld);
			regmap_update_bits(cs35l40->regmap,
				CS35L40_MIXER_NGATE_CH2_CFG,
				CS35L40_DSP_NG_THLD_MASK,
				cs35l40->pdata.dsp_ng_pcm_thld);
		...
		if (cs35l40->pdata.dsp_ng_delay) {
			regmap_update_bits(cs35l40->regmap,
				CS35L40_MIXER_NGATE_CH1_CFG,
				CS35L40_DSP_NG_DELAY_MASK,
				cs35l40->pdata.dsp_ng_delay <<
				CS35L40_DSP_NG_DELAY_SHIFT);
			regmap_update_bits(cs35l40->regmap,
				CS35L40_MIXER_NGATE_CH2_CFG,
				CS35L40_DSP_NG_DELAY_MASK,
				cs35l40->pdata.dsp_ng_delay <<
	...
	if (cs35l40->pdata.hw_ng_sel)
		regmap_update_bits(cs35l40->regmap,
				CS35L40_NG_CFG,
				CS35L40_HW_NG_SEL_MASK,
				cs35l40->pdata.hw_ng_sel <<
				CS35L40_HW_NG_SEL_SHIFT);

	if (cs35l40->pdata.hw_ng_thld)
		regmap_update_bits(cs35l40->regmap,
				CS35L40_NG_CFG,
				CS35L40_HW_NG_THLD_MASK,
				cs35l40->pdata.hw_ng_thld <<
				CS35L40_HW_NG_THLD_SHIFT);

	if (cs35l40->pdata.hw_ng_delay)
		regmap_update_bits(cs35l40->regmap,
				CS35L40_NG_CFG,
				CS35L40_HW_NG_DLY_MASK,
				cs35l40->pdata.hw_ng_delay <<
				CS35L40_HW_NG_DLY_SHIFT);
...
static int cs35l40_irq_gpio_config(struct cs35l40_private *cs35l40)
{
	...
	if (irq_gpio_cfg2->irq_src_sel == CS35L40_GPIO_CTRL_ACTV_LO)
		irq_pol = IRQF_TRIGGER_LOW;
	else if (irq_gpio_cfg2->irq_src_sel == CS35L40_GPIO_CTRL_ACTV_HI)
...
static int cs35l40_dsp_init(struct cs35l40_private *cs35l40)
{
	...
	cs35l40->amp_mute_rx2_restore = CS35L40_INPUT_SRC_ASPRX2;
	...
	regmap_write(cs35l40->regmap, CS35L40_DSP1_RX2_SRC, CS35L40_INPUT_SRC_ASPRX2);
...
static int cs35l40_probe(struct platform_device *pdev)
{
	...
	cs35l40->num_supplies = cs35l40_mfd->num_supplies;
	cs35l40->reset_gpio = cs35l40_mfd->reset_gpio;
	cs35l40->amp_mute = 1; /* unmuted */

	for (i = 0; i < cs35l40->num_supplies; i++)
		cs35l40->supplies[i].supply = cs35l40_mfd->supplies[i].supply;
	...
	*/
	...
	irq_pol = cs35l40_irq_gpio_config(cs35l40);
	...
	ret = devm_request_threaded_irq(cs35l40->dev, cs35l40->irq, NULL,
				cs35l40_irq, IRQF_ONESHOT | irq_pol,
				"cs35l40", cs35l40);
