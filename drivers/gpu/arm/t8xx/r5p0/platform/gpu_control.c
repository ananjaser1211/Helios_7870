...
#include <../../../../../../drivers/soc/samsung/pwrcal/S5E8890/S5E8890-vclk-internal.h>
#include <linux/clk.h>
#endif
...
static struct exynos_pm_domain *gpu_get_pm_domain(void)
{
	...
	ret = of_property_read_u32(np, "board_revision", &board_revision);
	if (ret < 0)
		board_revision = 0;
