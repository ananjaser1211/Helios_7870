...
static checksum_block checksum[] =
{
	...
	{0x5509A000+0x9ae00000, 0x5509A0C0+0x9ae00000, 0x0000000fb98c1f80}, /* varying_1_1_0_highpa.hex     */
	{0x5509A0C0+0x9ae00000, 0x5509A100+0x9ae00000, 0x0000000307f80000}, /* varying_1_1_1_highpa.hex     */
	{0x5509A100+0x9ae00000, 0x5509A1C0+0x9ae00000, 0x00000005f803a800}, /* varying_1_1_2_highpa.hex     */
	{0x5509A1C0+0x9ae00000, 0x5509A200+0x9ae00000, 0x000000040e800000}, /* varying_1_1_3_highpa.hex     */
	{0x5509A200+0x9ae00000, 0x5509A2C0+0x9ae00000, 0x0000000e2f5d87f0}, /* varying_1_1_4_highpa.hex     */
	{0x5509A2C0+0x9ae00000, 0x5509A300+0x9ae00000, 0x000000060f660000}, /* varying_1_1_5_highpa.hex     */
	{0x5509A300+0x9ae00000, 0x5509A3C0+0x9ae00000, 0x0000000a806ce0a8}, /* varying_1_1_6_highpa.hex     */
	{0x5509A3C0+0x9ae00000, 0x5509A400+0x9ae00000, 0x0000000411b70000}, /* varying_1_1_7_highpa.hex     */
	{0x5509A400+0x9ae00000, 0x5509A4C0+0x9ae00000, 0x0000000c82b7ef20}, /* varying_1_1_8_highpa.hex     */
	{0x5509A4C0+0x9ae00000, 0x5509A500+0x9ae00000, 0x000000050f080000}, /* varying_1_1_9_highpa.hex     */
	{0x5509A500+0x9ae00000, 0x5509A5C0+0x9ae00000, 0x0000000e7376e360}, /* varying_1_1_10_highpa.hex    */
	{0x5509A5C0+0x9ae00000, 0x5509A600+0x9ae00000, 0x000000070b3c0000}, /* varying_1_1_11_highpa.hex    */
	{0x5509A600+0x9ae00000, 0x5509A6C0+0x9ae00000, 0x0000000c756de980}, /* varying_1_1_12_highpa.hex    */
	{0x5509A6C0+0x9ae00000, 0x5509A700+0x9ae00000, 0x000000060ef80000}, /* varying_1_1_13_highpa.hex    */
	{0x5509A700+0x9ae00000, 0x5509A7C0+0x9ae00000, 0x0000000e34768300}, /* varying_1_1_14_highpa.hex    */
	{0x5509A7C0+0x9ae00000, 0x5509A800+0x9ae00000, 0x000000050a040000}, /* varying_1_1_15_highpa.hex    */
	{0x5509A800+0x9ae00000, 0x5509A8C0+0x9ae00000, 0x0000000e514abb00}, /* varying_1_1_16_highpa.hex    */
	{0x5509A8C0+0x9ae00000, 0x5509A900+0x9ae00000, 0x0000000509f00000}, /* varying_1_1_17_highpa.hex    */
	{0x5509A900+0x9ae00000, 0x5509AA20+0x9ae00000, 0x000000130f0d9800}, /* varying_1_1_18_highpa.hex    */
	{0x5509AA40+0x9ae00000, 0x5509AAA0+0x9ae00000, 0x000000050d140000}, /* varying_1_1_19_highpa.hex    */
	{0x5509F000+0x9ae00000, 0x5509F600+0x9ae00000, 0x00000003b18774cd}, /* tiler_cmdlist_1_1_highpa.hex */
	{0x5509E000+0x9ae00000, 0x5509EE00+0x9ae00000, 0x0000000713fd368c}, /* tiler_cmdlist_1_2_highpa.hex */
	{0x55075000+0x9ae00000, 0x55085400+0x9ae00000, 0x000003634d0d1c02}, /* output_colour_buff_1_3.hex   */
	{0x5503A000+0x9ae00000, 0x5503A200+0x9ae00000, 0x00000046bc13f4bb}, /* output_crc_buff_2_4.hex      */
	{0x5503B000+0x9ae00000, 0x5504B000+0x9ae00000, 0x00003fa41612ad18}, /* output_colour_buff_2_4.hex   */
	{0x550C0000+0x9ae00000, 0x550C3000+0x9ae00000, 0x000000f810fbb6d5}, /* output_crc_buff_1_2.hex		*/
};
...
bool balance_init(struct kbase_device *kbdev)
{
	...
	MALI_WRITE_REG((AS3_TRANSTAB_LO      ), 0xEFE26007);
	...
	MALI_WRITE_REG((AS0_TRANSTAB_LO      ), 0xEFE00007);
	...
	MALI_WRITE_REG((AS1_TRANSTAB_LO      ), 0xEFE0F007);
	...
	MALI_WRITE_REG((AS2_TRANSTAB_LO      ), 0xEFE1E007);
	...
	MALI_WRITE_REG((AS0_MEMATTR_HI       ), 0x88888888);
	MALI_WRITE_REG((AS0_MEMATTR_LO       ), 0x88888888);
	MALI_WRITE_REG((AS0_TRANSTAB_LO      ), 0xEFEB0007);
	MALI_WRITE_REG((AS0_TRANSTAB_HI      ), 0x00000000);
	MALI_WRITE_REG((AS0_COMMAND          ), 0x00000001);
	MALI_WRITE_REG((AS1_MEMATTR_HI       ), 0x88888888);
	MALI_WRITE_REG((AS1_MEMATTR_LO       ), 0x88888888);
	MALI_WRITE_REG((AS1_TRANSTAB_LO      ), 0xEFEB0007);
	MALI_WRITE_REG((AS1_TRANSTAB_HI      ), 0x00000000);
	MALI_WRITE_REG((AS1_COMMAND          ), 0x00000001);
	MALI_WRITE_REG((GPU_IRQ_CLEAR        ), 0x00000081);
	MALI_WRITE_REG((GPU_IRQ_MASK         ), 0x00000000);
