...
static const u32 *sensor_3l6_init_setfile_reset;
static u32 sensor_3l6_init_setfile_reset_size;
static const u32 *sensor_3l6_init_setfile_other;
static u32 sensor_3l6_init_setfile_other_size;

static u16 *sensor_3l6_init_setfile_burst;
static u32 sensor_3l6_init_setfile_burst_size;
...
int sensor_3l6_cis_sw_reset(struct v4l2_subdev *subdev)
{
	int ret = 0;
...
int sensor_3l6_cis_set_registers_burst(struct v4l2_subdev *subdev)
{
	int ret = 0;
	struct fimc_is_cis *cis;
	struct i2c_client *client;
	...
	ret = fimc_is_sensor_write16_array(client, sensor_3l6_init_setfile_burst[0],
			&sensor_3l6_init_setfile_burst[1], sensor_3l6_init_setfile_burst_size - 1);
	if (ret < 0) {
...
int sensor_3l6_cis_init(struct v4l2_subdev *subdev)
{
	...
	pr_info("sensor_3l6_cis_init_reg start");

	ret = sensor_3l6_cis_sw_reset(subdev);
	if (ret < 0) {
		err("sensor_3l6_cis_sw_reset fail!!");
		goto p_err;
	}

	ret = sensor_cis_set_registers(subdev, sensor_3l6_init_setfile_reset,
			sensor_3l6_init_setfile_reset_size);
	if (ret < 0) {
		err("sensor_3l6_set_registers - reset fail!!");
		goto p_err;
	}

	ret = sensor_3l6_cis_set_registers_burst(subdev);
	if (ret < 0) {
		err("sensor_3l6_set_registers - burst fail!!");
		goto p_err;
	}

	ret = sensor_cis_set_registers(subdev, sensor_3l6_init_setfile_other,
			sensor_3l6_init_setfile_other_size);
	if (ret < 0) {
		err("sensor_3l6_set_registers - other fail!!");
		goto p_err;
	}

	pr_info("sensor_3l6_cis_init_reg end");
...
//#endif
	...
	if (strcmp(setfile, "default") == 0 ||
		...
		sensor_3l6_init_setfile_reset = sensor_3l6_setfile_A_initial_reset;
		sensor_3l6_init_setfile_reset_size = sensor_3l6_setfile_A_initial_reset_size;
		sensor_3l6_init_setfile_burst = sensor_3l6_setfile_A_initial_burst;
		sensor_3l6_init_setfile_burst_size = sensor_3l6_setfile_A_initial_burst_size;
		sensor_3l6_init_setfile_other = sensor_3l6_setfile_A_initial_other;
		sensor_3l6_init_setfile_other_size = sensor_3l6_setfile_A_initial_other_size;
		...
		sensor_3l6_max_setfile_num = sizeof(sensor_3l6_setfiles_A) / sizeof(sensor_3l6_setfiles_A[0]);
	} else if (strcmp(setfile, "setB") == 0) {
		probe_info("%s setfile_B\n", __func__);
		sensor_3l6_init_setfile_reset = sensor_3l6_setfile_B_initial_reset;
		sensor_3l6_init_setfile_reset_size = sensor_3l6_setfile_B_initial_reset_size;
		sensor_3l6_init_setfile_burst = sensor_3l6_setfile_B_initial_burst;
		sensor_3l6_init_setfile_burst_size = sensor_3l6_setfile_B_initial_burst_size;
		sensor_3l6_init_setfile_other = sensor_3l6_setfile_B_initial_other;
		sensor_3l6_init_setfile_other_size = sensor_3l6_setfile_B_initial_other_size;
		...
		sensor_3l6_max_setfile_num = sizeof(sensor_3l6_setfiles_B) / sizeof(sensor_3l6_setfiles_B[0]);
	} else {
