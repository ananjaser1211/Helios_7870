...
static struct fimc_is_sensor_cfg config_module_3p8[] = {
	...
	/* 2312x1732@60fps */
	FIMC_IS_SENSOR_CFG(2312, 1732, 60, 30, 2, CSI_DATA_LANES_4),
	/* 2312x1732@30fps */
	FIMC_IS_SENSOR_CFG(2312, 1732, 30, 30, 3, CSI_DATA_LANES_4),
	/* 2312x1732@15fps */
	FIMC_IS_SENSOR_CFG(2312, 1732, 15, 30, 4, CSI_DATA_LANES_4),
	/* 2312x1300@60fps */
	FIMC_IS_SENSOR_CFG(2312, 1300, 60, 30, 5, CSI_DATA_LANES_4),
	/* 2312x1300@30fps */
	FIMC_IS_SENSOR_CFG(2312, 1300, 30, 30, 6, CSI_DATA_LANES_4),
	/* 1152x864@120fps */
	FIMC_IS_SENSOR_CFG(1152, 864, 120, 30, 7, CSI_DATA_LANES_4),
	/* 1152x648@120fps */
	FIMC_IS_SENSOR_CFG(1152, 648, 120, 30, 8, CSI_DATA_LANES_4),
#if 0
	/* 4640x3488@30fps */
	...
	struct exynos_platform_fimc_is_module *pdata)
{
	...
	if (gpio_is_valid(gpio_cam_2p8_en)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, gpio_cam_2p8_en, "CAM_LDO_EN high", PIN_OUTPUT, 1, 0);
	} else {
	...
	if (gpio_is_valid(gpio_cam_2p8_en)) {
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_OFF, gpio_cam_2p8_en, "CAM_LDO_EN high", PIN_OUTPUT, 0, 0);
	} else {
