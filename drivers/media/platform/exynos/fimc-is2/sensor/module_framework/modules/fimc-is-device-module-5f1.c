...
static struct fimc_is_sensor_cfg config_5f1[] = {
	/* 2400x2400@30fps */
	FIMC_IS_SENSOR_CFG(2400, 2400, 30, 45, 0, CSI_DATA_LANES_2)
};

static struct fimc_is_vci vci_module_5f1[] = {
...
static int sensor_5f1_s_format(struct v4l2_subdev *subdev, struct v4l2_mbus_framefmt *fmt)
{
	/* TODO */
	return 0;
}
...
static const struct v4l2_subdev_video_ops video_ops = {
	...
	.s_mbus_fmt = sensor_5f1_s_format,
};
		...
		struct exynos_platform_fimc_is_module *pdata)
{
	...
	if (!gpio_is_valid(gpio_iris_1p8_en)) {
		dev_err(dev, "%s: failed to get gpio_iris_1p8_en\n", __func__);
		return -EINVAL;
	} else {
	...
	gpio_iris_1p05_en = of_get_named_gpio(dnode, "gpio_iris_1p05_en", 0);
	if (!gpio_is_valid(gpio_iris_1p05_en)) {
		dev_err(dev, "%s: failed to get gpio_iris_1p05_en\n", __func__);
	} else {
		gpio_request_one(gpio_iris_1p05_en, GPIOF_OUT_INIT_LOW, "CAM_GPIO_OUTPUT_LOW");
		gpio_free(gpio_iris_1p05_en);
	}
	...
	//SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_ON,
		//gpio_iris_1p2_en, "gpio_iris_1p2_en", PIN_OUTPUT, 1, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_ON,
		gpio_iris_1p8_en, "gpio_iris_1p8_en_high", PIN_OUTPUT, 1, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_ON,
		gpio_iris_2p8_en, "gpio_iris_2p8_en_high", PIN_OUTPUT, 1, 0);
/*#ifdef CONFIG_SEC_FACTORY
	SET_PIN_VOLTAGE(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_ON,
		gpio_iris_1p05_en, "gpio_iris_1p05_en_high", PIN_OUTPUT, 1, 1000, 1000000);
#else
	SET_PIN_VOLTAGE(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_ON,
		gpio_iris_1p05_en, "gpio_iris_1p05_en_high", PIN_OUTPUT, 1, 1000, 1050000);
#endif*/
	SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_ON,
		gpio_iris_1p05_en, "gpio_iris_1p05_en_high", PIN_OUTPUT, 1, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_ON,
	...
	SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_OFF,
		gpio_iris_1p05_en, "gpio_iris_1p05_en_low", PIN_OUTPUT, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_OFF,
		gpio_iris_2p8_en, "gpio_iris_2p8_en_low", PIN_OUTPUT, 0, 0);
	SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_OFF,
		gpio_iris_1p8_en, "gpio_iris_1p8_en_low", PIN_OUTPUT, 0, 0);
	//SET_PIN(pdata, SENSOR_SCENARIO_SECURE, GPIO_SCENARIO_OFF,
		//gpio_iris_1p2_en, "gpio_iris_1p2_en", PIN_OUTPUT, 0, 0);
	...
	const struct i2c_device_id *id)
{
	...
	module->bitwidth = 8;
	module->vcis = ARRAY_SIZE(vci_module_5f1);
	module->vci = vci_module_5f1;
