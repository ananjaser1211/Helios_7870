...
static struct fimc_is_sensor_cfg config_gc5035[] = {
	/*2576x1932@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2576, 1932, 30, 19, 0, CSI_DATA_LANES_2, 897),
	/* 2560x1440@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2560, 1440, 30, 19, 1, CSI_DATA_LANES_2, 897),
	/* 2224x1080@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2224, 1080, 30, 19, 2, CSI_DATA_LANES_2, 897),
	/* 1920x1920@30fps */
	FIMC_IS_SENSOR_CFG_EXT(1920, 1920, 30, 19, 3, CSI_DATA_LANES_2, 897),
	/* 2576x1188@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2576, 1188, 30, 19, 4, CSI_DATA_LANES_2, 897),	
	/* 2576x1932@24fps */
	FIMC_IS_SENSOR_CFG_EXT(2576, 1932, 24, 19, 5, CSI_DATA_LANES_2, 897),
	/* 2560x1440@24fps */
	FIMC_IS_SENSOR_CFG_EXT(2560, 1440, 24, 19, 6, CSI_DATA_LANES_2, 897),
	/* 2224x1080@24fps */
	FIMC_IS_SENSOR_CFG_EXT(2224, 1080, 24, 19, 7, CSI_DATA_LANES_2, 897),
	/*1920x1920@24fps */
	FIMC_IS_SENSOR_CFG_EXT(1920, 1920, 24, 19, 8, CSI_DATA_LANES_2, 897),
	/*640x480@120fps */
	FIMC_IS_SENSOR_CFG_EXT(640, 480, 120, 9, 9, CSI_DATA_LANES_2, 448),
};
...
//	int gpio_mclk = 0;
	...
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_cam_2p8_en, "gpio_cam_2p8_en", PIN_OUTPUT, 1, 100);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_cam_1p2_en, "gpio_cam_1p2_en", PIN_OUTPUT, 1, 100);	

	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_reset, "sen_rst high", PIN_OUTPUT, 1, 100);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_ON, gpio_none, "pin", PIN_FUNCTION, 2, 50);
	...
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_reset, "sen_rst low", PIN_OUTPUT, 0, 20);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_cam_2p8_en, "gpio_cam_2p8_en", PIN_OUTPUT, 0, 2000);
	SET_PIN(pdata, SENSOR_SCENARIO_READ_ROM, GPIO_SCENARIO_OFF, gpio_cam_1p2_en, "gpio_cam_1p2_en", PIN_OUTPUT, 0, 0);
