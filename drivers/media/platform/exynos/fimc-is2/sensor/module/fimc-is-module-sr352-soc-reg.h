...
static struct sensor_reg sr352_Init_Reg[] =
{
	...
	//MCU reset after Analog setting
	...
	//LSC G channel reg________________________ 20141207 Kiran Sunny lens F2.4 82 percent bright
	{0x0e, 0x01}, //BURST_START


	//LSC G channel reg________________________ 
	{0x42, 0x56},
	{0x42, 0x85},
	{0x42, 0x93},
	{0x42, 0x57},
	...
	//LSC R channel reg________________________ 
	{0x42, 0x66},
	{0x42, 0x56},
	{0x42, 0xa4},
	{0x42, 0x68},
	...
	//LSC B channel reg________________________ 
	{0x42, 0x56},
	{0x42, 0xa5},
	{0x42, 0x7f},
	{0x42, 0x55},
	...
	{0x03, 0x20}, //Page 20
	{0x12, 0x20},// 13.7.19 3P lens dark mode issue 20 -> 60  digtial gain enable 
	...
	{0x60, 0xE0},// ramp gain
	{0x71, 0x80},//Digital gain max  // 13.7.19 3P lens dark mode issue
	...
	{0x97, 0x0e}, //Indoor_bRgStep
	{0x98, 0x11}, //Indoor_bBgStep
	...
	{0x26, 0x42},//Indoor_aTgtAngle
	{0x27, 0x45},//Indoor_aTgtAngle_a01
	{0x28, 0x53},//Indoor_aTgtAngle_a02
	{0x29, 0x59},//Indoor_aTgtAngle_a03   //h50->h4e Hando Extend MaxMax choi 0618
	{0x2a, 0x7c},//Indoor_aTgtAngle_a04

	{0x2b, 0x8d},//Indoor_aRgTgtOfs
	{0x2c, 0xa0},//Indoor_aRgTgtOfs_a01
	{0x2d, 0xa0},//Indoor_aRgTgtOfs_a02
	{0x2e, 0x05},//Indoor_aRgTgtOfs_a03 //h80->h84 Hando Extend MaxMax choi 0618
	{0x2f, 0x0e},//Indoor_aRgTgtOfs_a04 //h04->h00 choi 0618

	{0x30, 0xbd},//Indoor_aBgTgtOfs
	{0x31, 0x9a},//Indoor_aBgTgtOfs_a01
	{0x32, 0x9a},//Indoor_aBgTgtOfs_a02
	...
	{0x84, 0x15}, //Outdoor_wBgIntOfs_n01
	...
	{0x14, 0x65},//Outdoor_aTgtAngle
	{0x15, 0x6c},//Outdoor_aTgtAngle_a01
	{0x16, 0x73},//Outdoor_aTgtAngle_a02
	{0x17, 0x7b},//Outdoor_aTgtAngle_a03
	{0x18, 0x85},//Outdoor_aTgtAngle_a04
	...
	{0xe1, 0x0d},	// MCMC108_LowTemp mcmc2_allgain_y3
	{0xe2, 0x10},	// MCMC109_LowTemp mcmc2_allgain_y4
	{0xe3, 0x14},	// MCMC110_LowTemp mcmc2_allgain_y5
	...
	{0x6d, 0x15},//Hi-Temp_allgain_y8
	{0x6e, 0x12},//Hi-Temp_allgain_y9
	{0x6f, 0x0f},//Hi-Temp_allgain_y10
	{0x70, 0x13},//Hi-Temp_allgain_y11
...
static struct sensor_reg sr352_resol_720_720[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_resol_720_480[] = {
	{0xff, 0xff},
};
...
static struct sensor_reg sr352_resol_176_144_capture[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_resol_320_240_capture[] = {
	{0xff, 0xff},
};
...
static struct sensor_reg sr352_resol_720_480_capture[] = {
	{0xff, 0xff},
};
...
static struct sensor_reg sr352_resol_1536_1536_capture[] = {
	{0xff, 0xff},
};
...
static struct sensor_reg  sr352_fps_15_camcorder[] = {
	...
	///////////////////////////////////////////
	{0x03, 0x20},
	{0x3C, 0x00},	//Fix 15fps @ OPCLK 54.6MHz(1Line = 2200)
	{0x3D, 0x37},
	{0x3E, 0x86},
	{0x3F, 0x10},
...
static struct sensor_reg sr352_resol_1280_720_video[] = {
	///////////////////////////////////////////////////////////////////////////////
	// HD Initial Start
	///////////////////////////////////////////////////////////////////////////////
	...
	{0x71, 0x05}, //Out2_Adt_RgainMin
	{0x72, 0x30}, //Out2_Adt_RgainMin_n01
	{0x73, 0x05}, //Out2_Adt_RgainMax
	{0x74, 0xf0},//Out2_Adt_RgainMax_n01
	{0x75, 0x04}, //Out2_Adt_GgainMin
	{0x76, 0x00}, //Out2_Adt_GgainMin_n01
	{0x77, 0x04}, //Out2_Adt_GgainMax
	{0x78, 0x00}, //Out2_Adt_GgainMax_n01
	{0x79, 0x05}, //Out2_Adt_BgainMin
	{0x7a, 0xc0}, //Out2_Adt_BgainMin_n01
	{0x7b, 0x06}, //Out2_Adt_BgainMax
	{0x7c, 0x80}, //Out2_Adt_BgainMax_n01
	...
	{0x8a, 0x90}, // Cr _Sat_Indoor
	{0x8b, 0x85}, // Cr _Sat_Dark1
	{0x8c, 0x6a}, // Cr _Sat_Dark2
	{0x8d, 0x75}, // Cr _Sat_LowTemp
	...
	{0x20, 0x37},
	{0x21, 0x1f}, //Dark2 1137 //Pre Flat rate B[4:1] //04
	{0x22, 0x38},
	{0x23, 0x00}, //Dark2 1138 //Pre Flat R1 LumL
	{0x24, 0x39},
	...
	{0xa7, 0x48}, //Start ExpTime 120fps flaot OPCLK 43.3
	{0xa8, 0xb0},
	{0xa9, 0x25},
	{0xaa, 0xc0},
...
static struct sensor_reg sr352_resol_720_480_video[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_resol_640_480_video[] = {
	{0xff, 0xff},
};

static struct sensor_reg sr352_resol_320_240_video[] = {

};

static struct sensor_reg sr352_resol_176_144_video[] = {
	{0xff, 0xff},
};
